package ru.somarov.templates.java.pattern.strategy;

import java.util.Objects;

import static org.bytedeco.ffmpeg.global.avutil.NAN;
...
class QuadraticEquationSolver
{
    ...
    {
        Complex sqrt = Complex.sqrt(strategy.calculateDiscriminant(a, b, c));
        Complex first = new Complex(-b,0).plus(sqrt).divides(new Complex(2*a,0));
        Complex second = new Complex(-b,0).minus(sqrt).divides(new Complex(2*a,0));
